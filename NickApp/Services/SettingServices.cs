...
namespace NickApp.Services
{
    public class SettingServices : ISettingServices
    {
        ...
        public string DataSourceName => "NickSQLite.db3";
        ...
        public string SyncApiUrl => Device.RuntimePlatform == Device.Android ? "http://localhost:8090/api/sync" : "http://localhost:8090/api/sync";
